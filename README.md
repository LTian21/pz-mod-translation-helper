...
<!--START_STATUS_BADGES-->
![翻译进度](https://img.shields.io/badge/%E7%BF%BB%E8%AF%91%E8%BF%9B%E5%BA%A6-52584%20/%2066227%20%2879.4%25%29-yellow)
![支持模组](https://img.shields.io/badge/%E6%94%AF%E6%8C%81%E6%A8%A1%E7%BB%84-620%20%E4%B8%AA-blue)
<!--END_STATUS_BADGES-->
...
1.  **下载工具**：在本仓库中找到并下载 `translation_utils/可视化翻译工具/` 目录下的最新版本翻译工具。
2.  **运行并领取任务**：运行工具后，它可以为您自动领取一个翻译任务。
3.  **进行翻译**：在工具内根据提示完成翻译或校对工作。
4.  **提交审核**：完成后，只需在工具内填入您的贡献者名称和邮箱，然后点击“提交审核”。
5.  **自动创建 PR**：工具将自动为您的贡献创建一个 Pull Request。您无需进行任何 Git 操作！
